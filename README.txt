...
This interactive web application helps cancer researchers and clinicians explore how gene expression 
affects survival outcomes in breast cancer subtypes. Built with Dash and Plotly, it enables real-time 
survival analysis and differential expression comparisons using TCGA and METABRIC datasets — no coding required.
...
Breast Cancer RNA-Seq Explorer: https://breast-cancer-rna-seq-explorer.onrender.com/
